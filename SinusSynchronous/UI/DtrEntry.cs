    ...
    private void Update()
    {
        ...
        if (_apiController.IsConnected)
        {
            ...
            if (pairCount > 0)
            {
                ...
                tooltip = $"Sinus Synchronous: Connected{Environment.NewLine}----------{Environment.NewLine}{string.Join(Environment.NewLine, visiblePairs)}";
                colors = _configService.Current.DtrColorsPairsInRange;
            }
            else
            {
                tooltip = "Sinus Synchronous: Connected";
        ...
        {
            text = "\uE044 \uE04C";
            tooltip = "Sinus Synchronous: Not Connected";
