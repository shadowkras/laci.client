...
public class CompactUi : WindowMediatorSubscriberBase
{
        ...
        : base(logger, mediator, "###MareSynchronosMainUI", performanceCollectorService)
    {
        ...
        WindowName = $"Sinus Synchronous {dev} ({ver.Major}.{ver.Minor}.{ver.Build})###MareSynchronosMainUI";
        Toggle();
#else
        var ver = Assembly.GetExecutingAssembly().GetName().Version;
        WindowName = "Sinus Synchronous " + ver.Major + "." + ver.Minor + "." + ver.Build + "###MareSynchronosMainUI";
#endif
