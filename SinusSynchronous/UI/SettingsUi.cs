...
public class SettingsUi : WindowMediatorSubscriberBase
{
    ...
    public SettingsUi(ILogger<SettingsUi> logger,
        ...
        DalamudUtilService dalamudUtilService, HttpClient httpClient) : base(logger, mediator, "Sinus Synchronous Settings", performanceCollector)
    {
    ...
    private void DrawBlockedTransfers()
    {
        ...
        UiSharedService.ColorTextWrapped("Files that you attempted to upload or download that were forbidden to be transferred by their creators will appear here. " +
                             ...
                             "Ask your paired friend to send you the mod in question through other means, acquire the mod yourself or pester the mod creator to allow it to be sent over Sinus.",
...
eeeeeeeeeee            if (ApiController.AnyServerConnected && ImGui.BeginTabItem("Transfers"))
    ...
    private void DrawFileStorageSettings()
    {
        ...
        UiSharedService.TextWrapped("Sinus stores downloaded files from paired people permanently. This is to improve loading performance and requiring less downloads. " +
        ...
        if (_cacheMonitor.SinusWatcher == null || _cacheMonitor.PenumbraWatcher == null)
        {
            ...
            UiSharedService.AttachToolTip("Attempts to resume monitoring for both Penumbra and Sinus Storage. "
        ...
        ImGui.Separator();
        UiSharedService.TextWrapped("File Storage validation can make sure that all files in your local Sinus Storage are valid. " +
    ...
    private void DrawGeneral()
    {
        ...
        _uiShared.DrawHelpText("This will add Sinus related right click menu entries in the game UI on paired players.");
        ...
        _uiShared.DrawHelpText("This will add Sinus connection status and visible pair count in the Server Info Bar.\nYou can further configure this through your Dalamud Settings.");
        ...
        if (ImGui.Checkbox("Show Sinus Profiles on Hover", ref showProfiles))
        {
    ...
    private void DrawPerformance()
    {
        ...
        _uiShared.DrawHelpText("Will show a performance indicator when players exceed defined thresholds in Sinus UI." + Environment.NewLine + "Will use warning thresholds.");
        ...
        _uiShared.DrawHelpText("Sinus will print a warning in chat once per session of meeting those people. Will not warn on players with preferred permissions.");
        using (ImRaii.Disabled(!warnOnExceedingThresholds && !showPerformanceIndicator))
        {
            ...
            _uiShared.DrawHelpText("Sinus will also print warnings and show performance indicator for players where you enabled preferred permissions. If warning in general is disabled, this will not produce any warnings.");
        }
    ...
    private void DrawServerConfiguration()
    {
        ...
        if (ImGui.BeginTabBar("serverTabBar"))
        {
            if (ImGui.BeginTabItem("Character Management"))
            {
                ...
                {
                    UiSharedService.ColorTextWrapped("Characters listed here will automatically connect to the selected Sinus service with the settings as provided below." +
                    ...
                    foreach (var item in selectedServer.Authentications.ToList())
                    {
                        ...
                        if (ImGui.Checkbox("Automatically login to Sinus", ref isAutoLogin))
                        {
    ...
    private void DrawSettingsContent()
    {
        ...
        ImGui.SameLine();
        if (ImGui.Button("Sinus Synchronos Discord"))
        {
