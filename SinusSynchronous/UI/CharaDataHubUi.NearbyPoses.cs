...
internal partial class CharaDataHubUi
{
    private void DrawNearbyPoses()
    {
        ...
        UiSharedService.DrawTree("Settings & Filters", () =>
        {
            ...
            _uiSharedService.DrawHelpText("When enabled, Sinus will draw floating wisps where other's poses are in the world.");
            ...
            _uiSharedService.DrawHelpText("This will allow Sinus to continue the calculation of position of wisps etc. active outside of the 'Poses Nearby' tab." + UiSharedService.TooltipSeparator
