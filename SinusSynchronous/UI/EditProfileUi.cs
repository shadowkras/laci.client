...
public class EditProfileUi : WindowMediatorSubscriberBase
{
    ...
    public EditProfileUi(ILogger<EditProfileUi> logger, MareMediator mediator,
        ...
        : base(logger, mediator, "Sinus Synchronous Edit Profile###MareSynchronosEditProfileUI", performanceCollectorService)
    {
        IsOpen = false;
    ...
    protected override void DrawInternal()
    {
        ...
        ImGui.TextWrapped($"- All users that are paired and unpaused with you will be able to see your profile picture and description.{Environment.NewLine}" +
            ...
            $"- In case of valid reports from other users this can lead to disabling your profile forever or terminating your Sinus account indefinitely.{Environment.NewLine}" +
