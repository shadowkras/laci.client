...
internal sealed partial class CharaDataHubUi : WindowMediatorSubscriberBase
{
    ...
    public CharaDataHubUi(ILogger<CharaDataHubUi> logger, MareMediator mediator, PerformanceCollectorService performanceCollectorService,
        ...
        : base(logger, mediator, "Mare Synchronous Character Data Hub###MareSynchronosCharaDataUI", performanceCollectorService)
    {
    ...
    private void DrawMcdfExport()
    {
        ...
        DrawHelpFoldout("This feature allows you to pack your character into a MCDF file and manually send it to other people. MCDF files can officially only be imported during GPose through Sinus. " +
