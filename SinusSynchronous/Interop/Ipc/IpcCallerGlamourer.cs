...
public sealed class IpcCallerGlamourer : DisposableMediatorSubscriberBase, IIpcCaller
{
    ...
    public IpcCallerGlamourer(ILogger<IpcCallerGlamourer> logger, IDalamudPluginInterface pi, DalamudUtilService dalamudUtil, SinusMediator sinusMediator,
        RedrawManager redrawManager) : base(logger, sinusMediator)
    {
    ...
    public void CheckAPI()
    {
        ...
        finally
        {
            if (!apiAvailable && !_shownGlamourerUnavailable)
            {
                ...
                _sinusMediator.Publish(new NotificationMessage("Glamourer inactive", "Your Glamourer installation is not active or out of date. Update Glamourer to continue to use Sinus. If you just updated Glamourer, ignore this message.",
        ...
        try
        {
            ...
            await _redrawManager.PenumbraRedrawInternalAsync(logger, handler, applicationId, (chara) =>
            {
                try
                {
                    ...
                    _sinusMediator.Publish(new PenumbraRedrawCharacterMessage(chara));
                }
                catch (Exception ex)
                {
    ...
    {
        _sinusMediator.Publish(new GlamourerChangedMessage(address));
    }
}
