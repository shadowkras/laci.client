...
public record UnPauseMessage(int ServerIndex, UserData UserData) : MessageBase;
public record UserAddPairMessage(int ServerIndex, UserData UserData) : MessageBase;
public record SendPairRequestMessage(string? TargetIdent = null, UserData? UserData = null) : MessageBase;
public record SendPairRejectionMessage(string? TargetIdent = null, UserData? UserData = null) : MessageBase;
public record ConfirmAddDirectPairMessage(int ServerIndex, UserData UserData) : MessageBase;
public record DeclineAddDirectPairMessage(int ServerIndex, UserData UserData) : MessageBase;
...
public record OpenPermissionWindowMessage(IEnumerable<Pair> Pairs) : MessageBase;
