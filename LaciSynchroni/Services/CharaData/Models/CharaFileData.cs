...
public record CharaFileData
{
    ...
    public CharaFileData() { }
    public CharaFileData(FileCacheManager manager, string description, CharacterData dto)
    {
    ...
    public static CharaFileData FromByteArray(byte[] data)
    {
        return JsonSerializer.Deserialize<CharaFileData>(Encoding.UTF8.GetString(data))!;
    }
