...
public partial class SyncHubClient
{
    public async Task<CharaDataFullDto?> CharaDataCreate()
    {
        ...
        try
        {
            ...
            return await _connection!.InvokeAsync<CharaDataFullDto?>(nameof(CharaDataCreate)).ConfigureAwait(false);
        }
        catch (Exception ex)
        {
    ...
    public async Task<List<CharaDataFullDto>> CharaDataGetOwn()
    {
        ...
        try
        {
            ...
            return await _connection!.InvokeAsync<List<CharaDataFullDto>>(nameof(CharaDataGetOwn)).ConfigureAwait(false);
        }
        catch (Exception ex)
        {
    ...
    public async Task<List<CharaDataMetaInfoDto>> CharaDataGetShared()
    {
        ...
        {
            Logger.LogDebug("Getting all own chara data");
            return await _connection!.InvokeAsync<List<CharaDataMetaInfoDto>>(nameof(CharaDataGetShared)).ConfigureAwait(false);
        }
        catch (Exception ex)
        {
    ...
    public async Task<string> GposeLobbyCreate()
    {
        ...
        try
        {
            ...
            return await _connection!.InvokeAsync<string>(nameof(GposeLobbyCreate)).ConfigureAwait(false);
        }
        catch (Exception ex)
        {
    ...
    public async Task<bool> GposeLobbyLeave()
    {
        ...
        try
        {
            ...
            return await _connection!.InvokeAsync<bool>(nameof(GposeLobbyLeave)).ConfigureAwait(false);
        }
        catch (Exception ex)
        {
    ...
    public async Task GposeLobbyPushCharacterData(CharaDataDownloadDto charaDownloadDto)
    {
        ...
        try
        {
            ...
            await _connection!.InvokeAsync(nameof(GposeLobbyPushCharacterData), charaDownloadDto).ConfigureAwait(false);
        }
        catch (Exception ex)
        {
    ...
    public async Task GposeLobbyPushPoseData(PoseData poseData)
    {
        ...
        try
        {
            ...
            await _connection!.InvokeAsync(nameof(GposeLobbyPushPoseData), poseData).ConfigureAwait(false);
        }
        catch (Exception ex)
        {
    ...
    public async Task GposeLobbyPushWorldData(WorldData worldData)
    {
        ...
        try
        {
            await _connection!.InvokeAsync(nameof(GposeLobbyPushWorldData), worldData).ConfigureAwait(false);
        }
        catch (Exception ex)
        {
